    ...
    return (
        <div className="container flex flex-col justify-center items-center mx-auto">
            <div className="w-full text-center">
                ...
                <h1 className="mb-2 text-2xl font-bold text-[#262626] title-font md:text-4xl">{t('404.title')}</h1>
                <img className="w-36 mx-auto mb-12" src={img} alt="wutface emote" />
                <div className="flex justify-center">
                    <Link to="/">
                        <button className="duration-200 flex inline-flex items-center text-[#262626] hover:text-opacity-60 border-0 py-2 px-6 focus:outline-none rounded text-md mr-4">
                            {t('404.button')}
